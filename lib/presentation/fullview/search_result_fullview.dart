...
import 'package:yts_app/presentation/fullview/widgets/searchDownloadbutton.dart';
import 'package:yts_app/presentation/widgets/main_titles.dart';

class SearchFullView extends StatelessWidget {
  final SearchResultMovies dataList;

  const SearchFullView({Key? key, required this.dataList}) : super(key: key);
