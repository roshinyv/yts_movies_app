...
/// @nodoc
mixin _$SearchState {
  List<SearchResultMovies> get searchResultList =>
      throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  $Res call(
      {List<SearchResultMovies> searchResultList,
      List<Movie> idleList,
      bool isLoading,
      bool isError});
}
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      {required final List<SearchResultMovies> searchResultList,
  ...
  final List<SearchResultMovies> _searchResultList;
  @override
  List<SearchResultMovies> get searchResultList {
